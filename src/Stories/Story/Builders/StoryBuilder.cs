    ...
    public class StoryBuilder
    {
        ...
        public StoryBuilder()
        {
            story = new Story()
            {
                ...
                Content = new Content(String.Empty),
                Rating = new Rating()
            };
        }
        ...
        {
            story.Language = this.GetLanguage(language);
            return this;
        }
        ...
        public StoryBuilder WithAnyImage()
        {
            if (story.VisualRepresentation == null)
            {
                story.VisualRepresentation = new VisualRepresentation()
                {
                    Images = new List<Image>()
                };
            }

            story.VisualRepresentation.Images.Add(new Image(0, new Data(this.GetImage())));
            return this;
        }
